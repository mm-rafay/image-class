...
sudo kubectl apply -f k8s-namespace-pvc.yaml      # contains Namespace and PVCs
...
sudo kubectl apply -f k8s-inference-deployment.yaml
sudo kubectl apply -f k8s-inference-service.yaml
